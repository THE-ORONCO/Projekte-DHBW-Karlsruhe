...
public class MuseumsElementManager {
	...
	/**
	 * gibt zurueck ob ein Element mit diesem Primarykey in diesem
	 * MuseumsElementManager enthalten ist
	 *
	 ...
	 * @throws Exception wenn das Objekt oder ein Objekt mit gleichem Primarykey
	...
	public void persist(MuseumsElement element) throws Exception {
		if (this.contains(element)) {
			...
			throw new Exception(
					"Museumselement mit diesem PrimaryKey existiert bereits in diesem MuseumsElementManager!");
		}
	 ...
	 * @return ob ein solches Objekt vorhanden war und es somit entfernt wurde als
	 *         boolean
	 */
